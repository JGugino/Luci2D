...
public class UIProgressBarObject extends UIObject{
	...
	public UIProgressBarObject(float _objectX, float _objectY, Color _barBackgroundColor ,Color _barFillColor, int _objectWidth, int _objectHeight, BarStyle _barStyle, float _maxValue) {
		super(_objectX, _objectY, UIObjectType.PROGRESS_BAR);
	...
	public UIProgressBarObject(float _objectX, float _objectY, BufferedImage _barBackgroundImage ,BufferedImage _barFillImage, int _objectWidth, int _objectHeight, BarStyle _barStyle, float _maxValue) {
		super(_objectX, _objectY, UIObjectType.PROGRESS_BAR);
